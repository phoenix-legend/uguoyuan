            ...
            "sub_button" => [
                {
                    "name" => "冬季~梨配蜂蜜蒸着吃",
                    "type" => "view",
                    "url" => "http://mp.weixin.qq.com/bizmall/malldetail?id=&pid=pliNLwGUt0gikabCWvYfwAxBQB-c&biz=MzIyNjE0OTc4Mg==&scene=&action=show_detail&showwxpaytitle=1#wechat_redirect"
                },
                {
                    "name" => "小孩咳嗽配川贝~健康",
                    "type" => "view",
